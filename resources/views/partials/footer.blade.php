            ...
            <div class="row row-40 row-md-50 justify-content-xl-between">
                ...
                <div class="col-sm-6 col-md-7 col-lg-5 wow fadeInRight" data-wow-delay=".1s">
                    ...
                    <ul class="footer-modern-list footer-modern-list-2 d-sm-inline-block d-md-block">
                        <li><a href="{{ route('home') }}#main">Главная</a></li>
                        <li><a href="{{ route('home') }}#services">Услуги</a></li>
                        <li><a href="{{ route('home') }}#about">О нас</a></li>
                        <li><a href="{{ route('home') }}#reviews">Отзывы</a></li>
                        <li><a href="{{ route('home') }}#gallery">Галлерея</a></li>
                        <li><a href="{{ route('home') }}#team">Инструкторы</a></li>
                ...
                <div class="col-sm-6 col-md-5 col-lg-4 col-xl-3 wow fadeInRight" data-wow-delay=".2s">
                    ...
                    <ul class="list-inline list-social-3 list-inline-sm">
                        <li><a class="icon mdi mdi-telegram icon-xxs" href="https://t.me/divingaquastyle74" target="_blank"></a></li>
